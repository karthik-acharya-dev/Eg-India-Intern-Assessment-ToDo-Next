  ...
  return (
    <main className={rubik.className}>
      <div className="w-full h-auto px-6 md:px-20 lg:px-56 py-10 md:py-20">
        <div className="bg-white w-full min-h-[80vh] shadow-[0px_0px_4px_0px_rgba(0,_0,_0,_0.1)] border-[1px] border-gray-200 rounded-[32px] p-4 md:p-8 lg:py-16 lg:px-40 flex flex-col gap-4">
          ...
          <Footer onDeleteAll={onDeleteAll} taskCount={tasks.length} />
        </div>
      </div>
    </main>
  );
